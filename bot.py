...
def get_market_data(symbol="QQQ", timeframe=TimeFrame.Hour, limit=100):
    """Fetches historical stock bars to calculate indicators using the free real-time IEX feed."""
    ...
    request_params = StockBarsRequest(
        ...
        feed=DataFeed.IEX  # Enables real-time data access on the free tier
    )
